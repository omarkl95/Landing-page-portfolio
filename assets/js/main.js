...
//////////////////////Start Navbar Change color SCROLL ////////////////////////////////

$(window).scroll(function(){
	var windowscroll = $(window).scrollTop();
	var offset = $('#section_about').offset().top;
	if (windowscroll >offset){
	   $(".navbar").css("backgroundColor","rgb(255, 255, 255)" );
	   $('.navbar').css('border-bottom','1px solid #ddd')
	   $('.navbar-nav li a').css('color','#050607');
	   $('.navbar-brand h2').css('color','#050607');
	   $(".navbar").css( "Color", "rgb(5, 6, 7);")
 ...
 ///////////  typed.js  Plugin////////////
var typed2 = new Typed('.is-hidden', {
    strings: ['<b class="color-fb">Creating Websites</b>', '<b class="color-fb">Designing UX/UI</b>','<b class="color-fb">Angular 8</b>'],
    typeSpeed: 20,
    backSpeed: 20,
    loop: true
  });
...
//////////////////////Start Navbar Change color SCROLL ////////////////////////////////
 ...
 //////////////////////ENd Navbar Change color SCROLL ////////////////////////////////
